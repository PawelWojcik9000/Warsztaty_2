...
--
-- Baza danych: `workshop_2`
--
CREATE DATABASE IF NOT EXISTS `workshop_2` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `workshop_2`;
...
(1, 'a.asdfg', '$2a$10$sBze500jiJKqXFdp2GiMeupgvoMIQZxwOSs.AiBvfCMe.adyrD6Dq', '$2a$10$sBze500jiJKqXFdp2GiMeu', 'a.asdfg@wp.pl', NULL),
(2, 'b.xcytr', '$2a$10$QlRijikMVmY97MEI2L8/puXS2RauryVetFThQmrDirkAR.aDTRVc.', '$2a$10$QlRijikMVmY97MEI2L8/pu', 'b.xcytr@wp.pl', NULL),
(3, 'c.qwerty', '$2a$10$BDc3vaQleA6QjdH96u3Sa.nkgUl31dKXkgR60jFE2tj71IB1hpAdS', '$2a$10$BDc3vaQleA6QjdH96u3Sa.', 'c.qwerty@wp.pl', NULL);
